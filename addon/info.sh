...
neofetch
echo " "
echo "♤♤♤♤Script Install Vpn By Rocknet Store♤♤♤♤" | tee -a log-install.txt
echo "" | tee -a log-install.txt
echo "♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤♤" | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "   >>> Service & Port"  | tee -a log-install.txt
echo "   - OpenSSH                 : 442, 22"    | tee -a log-install.txt
echo "   - OpenVPN                 : TCP 1194, UDP 2200, SSL 443, 990"  | tee -a log-install.txt
echo "   - Stunnel4                : 443, 777, 789"   | tee -a log-install.txt
...
echo "   - Vmess gRPC              : 3480"   | tee -a log-install.txt
echo "   - Vless gRPC              : 3880"   | tee -a log-install.txt
echo " ---------------------------------------------------"
echo "   - Websocket TLS           : 443, 777"  | tee -a log-install.txt
echo "   - Websocket None TLS      : 443, 8880"  | tee -a log-install.txt
...
echo "   - Recode                  : Rocknet Store" | tee -a log-install.txt
