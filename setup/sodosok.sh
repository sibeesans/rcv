...
>>"/etc/shadowsocks-libev/akun.conf"
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/rockneters/rockvpn/main/add/addss.sh"
wget -O delss "https://raw.githubusercontent.com/rockneters/rockvpn/main/del/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/rockneters/rockvpn/main/cek/cekss.sh"
wget -O renewss "https://raw.githubusercontent.com/rockneters/rockvpn/main/renew/renewss.sh"
wget -O trialss "https://raw.githubusercontent.com/rockneters/rockvpn/main/trial/trialss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
